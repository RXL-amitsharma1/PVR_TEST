...
class RelativeDateConverterSpec extends Specification {
    ...
    void "test for more Inputs parameter "() {
        ...
        "lastXDays"   | [new Date("Thu Nov 20 14:19:22 $TEST_TZ 2014"), 1, "UTC"]  | [new Date("Wed Nov 19 00:00:00 $TEST_TZ 2014"), new Date("Wed Nov 19 23:59:59 $TEST_TZ 2014")]
    ...
    void "test for lastXDays "() {
        ...
        then: "We set the value in result"
        result == [new Date("Sat Nov 22 00:00:00 $TEST_TZ 2014"), new Date("Sun Nov 23 23:59:59 $TEST_TZ 2014")]

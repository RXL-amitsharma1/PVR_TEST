...
class QualityCaseData implements Serializable {
    ...
    static mapping = {
        table('QUALITY_CASE_DATA')
        id column: 'ID', generator: "sequence", params: [sequence: "QUALITY_CASE_DATA_ID"]
        ...
        actionItems joinTable: [name: "QUALITY_CASE_ACTION_ITEMS", column: "ACTION_ITEM_ID", key: "QUALITY_CASE_ID"]
        comments joinTable: [name: "QUALITY_CASE_COMMENTS", column: "COMMENT_ID", key: "QUALITY_CASE_ID"]
        issues joinTable: [name: "QUALITY_CASE_ISSUES", column: "ISSUE_ID", key: "QUALITY_CASE_ID"]
        qualityIssueDetails joinTable: [name: "QUALITY_CASE_ISSUE_DETAILS", column: "QUALITY_ISSUE_DETAIL_ID", key: "QUALITY_CASE_ID"]
    ...
    void updateDueDate(WorkflowRule _workflowRule) {
        ...
        WorkflowRule workflowRule = _workflowRule ?: WorkflowRule.getDefaultWorkFlowRuleByType(WorkflowConfigurationTypeEnum.QUALITY_CASE_DATA)

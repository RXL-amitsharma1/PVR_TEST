...
class SourceTableMaster {
    ...
    static mapping = {
        ...
        tableName column: "TABLE_NAME"              // Name of the case table as it exists in the db ( C_IDENTIFICATION )
        tableAlias column: "TABLE_ALIAS"            // Alias used in the generated SQL ( C_IDENTIFICATION = cm )
...
// this method is to compare pva _ app value with pvr one
    ...
    public static void copyObj(SourceTableMaster sourceObj, SourceTableMaster targetObj) {
        targetObj.with {
            tableAlias = sourceObj.tableAlias
            tableType = sourceObj.tableType
            caseJoinOrder = sourceObj.caseJoinOrder
            versionedData = sourceObj.versionedData
            caseJoinType = sourceObj.caseJoinType
            hasEnterpriseId = sourceObj.hasEnterpriseId

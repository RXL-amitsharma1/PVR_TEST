...
ColumnView.prototype.CustomSelect = (function () {
    ...
    CustomSelect.prototype = {
        ...
        _monkeyPatchEl: function monkeyPatchEl() {
            var that = this;
            var selectIndex = this.selectIndex.on(this);
            var movePosition = this.movePosition.on(this);
            var deselect = this.deselect.on(this);
            var clear = this.clear.on(this);
            var selectValue = this.selectValue.on(this);
            var selectPath = this.selectPath.on(this);
            var highlightValue = this.highlightValue.on(this);
            var elMethods = {

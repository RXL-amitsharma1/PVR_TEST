    ...
    var init_table = function () {
        var table = $('#rxTableConfiguration').DataTable({
            ...
            "aoColumns": [
                ...
                },
                {
                    ...
                    mRender: function (data, type, row) {
                        var ico = "";
                        if (row.isPublisherReport && ($("#allReportsFilter").is(":checked") || !isPublisherReport)) ico = '<sup type="' + $.i18n._('publisherReport') + '" style="font-weight: bold;">PVP</sup>';
                        var content =  encodeToHTML(data);
                        return "<div class='three-row-dot-overflow' >"+content+ ico+"</div>";
                    }
                },
                {
                    "mData": "description",
                ...
                },
                {
                    ...
                    render: function (data) {
                        const encodedData = data ? encodeToHTML(data) : '';
                        return "<div class='three-row-dot-overflow'>" + encodedData + "</div>";
                    }
                },
                {
                    "mData": "tags",
                ...
                {"mData": "createdBy"},
                {
                    ...
                    "mRender": function (data, type, full) {
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu" style="min-width: 80px !important; font-size: 12px;"> \
                            <li role="presentation"><a role="menuitem" href="' + CONFIGURATION.viewUrl + '/' + data["id"] + (full.isPublisherReport ? "?pvp=true" : "") + '">' + $.i18n._('view') + '</a></li> \
                            <li role="presentation"><a role="menuitem" href="' + CONFIGURATION.editUrl + '/' + data["id"] + (full.isPublisherReport ? "?pvp=true" : "") + '">' + $.i18n._('edit') + '</a></li> \
                        ...
                        if(isPriorityRoleEnable) {
                            actionButton = actionButton + '<li role="presentation"><a role="menuitem" data-evt-clk=\'{\"method\": \"disableEventBinding\", \"params\":[]}\' href="' + CONFIGURATION.runUrl + '/' + data["id"] + '?isPriorityReport=true">' + $.i18n._('prioritize.report') + '</a></li>';
                        }
            ...
            initComplete: function () {
                ...
                $("#typeFilter").select2({placeholder: "Document Type", allowClear: true});
                ...
                $("#allReportsFilter, #typeFilter").on("select2:open", function (e) {

...
// We have added custom fix for the issue of Date Shift. Check Ticket PVR-2944, PVR-8493
...
// TODO !IMPORTANT while upgrading We would need to add additional support for Yearly interval as requested in PVR-8493 which's not standard offering by plugin .
...
( function( factory ) {
    ...
    ( function( $ ) {
        ...
        var Datepicker = function( element, options ) {
            ...
            this.additionalParserFormat = this.options.additionalParserFormat || this.additionalParserFormat;
            this.textAllowed = this.options.textAllowed || this.textAllowed;
        ...
        Datepicker.prototype = {
            ...
            onYearScroll: function( e ) {
                ...
                if ( topPercentage < 5 ) {
                    ...
                    for ( i = ( start - 1 ); i > ( start - 11 ) && i > 0; i-- ) {
            ...
            parseDate: function( date ) {
                var self = this;
                var BAD_DATE = self.textAllowed ? new Date(NaN) : new Date();
                ...
                if ( date ) {
                    if ( this.moment ) { //if we have moment, use that to parse the dates
                        momentParseWithFormat = function( d ) {
                            var md = moment( d, [self.momentFormat].concat(self.additionalParserFormat) );
        ...
        $.fn.datepicker.defaults = {
            ...
            date: new Date(),
            formatDate: null,
            additionalParserFormat: ["DD-MM-YYYY","DDMMYYYY","YYYY-MM-DD","DD/MMM/YYYY","YYYY/MM/DD","DD-MMM-YYYY"],
            textAllowed: false,
            momentConfig: {
                culture: 'en',
    ...
    ( function( $ ) {
        ...
        Scheduler.prototype = {
            ...
            getValue: function getValue() {
                ...
                if ( repeat === 'none' ) {
                ...
                } else if ( repeat === 'afterEveryEtl' ) {
                    pattern = 'FREQ=AFTER_EVERY_ETL;';
                    ...
                    pattern += 'FREQ=YEARLY;';
                    pattern += 'INTERVAL=' + interval + ';'; // !important Fix for PVR-8493 feature request which require's years frequency
            ...
            _parseAndSetRecurrencePattern: function( recurrencePattern, startTime ) {
                ...
                } else if ( recur.FREQ === 'AFTER_EVERY_ETL' ) {
                    item = 'afterEveryEtl';

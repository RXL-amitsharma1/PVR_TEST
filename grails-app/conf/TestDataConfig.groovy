...
testDataConfig {
    sampleData {
        ...
        'com.rxlogix.config.ReportTemplate' {
            name:"test"
          //  createdBy:normalUser
          //  selectedFieldsColumns:selectedFields
        }
        'com.rxlogix.config.DateRangeInformation' {
            relativeAbsoluteCumulativeDateRange: "DateRangeValue.CUMULATIVE"
            relativeDateRangeValue: "2"

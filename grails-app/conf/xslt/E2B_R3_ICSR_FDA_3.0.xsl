...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:hl7-org:v3">
    ...
    <xsl:template match="/">
        <MCCI_IN200100UV01 ITSVersion="XML_1.0">
            ...
            <!--M.x - Message Header-->
            <xsl:apply-templates select="/ichicsr/ichicsrtransmissionidentification" mode="part_a"/>
            <!--Report-->
    ...
    <xsl:template match="ichicsrtransmissionidentification" mode="part_a">
        ...
        <interactionId root="{$oidBatchHeaderInteractionId}" extension="MCCI_IN200100UV01"/>
        <!--EU message types-->
        <xsl:choose>
            <xsl:when test="messagetype = 'ichicsr'">
                <name code="1" codeSystem="{$oidMessageType}" displayName="ichicsr" />
            </xsl:when>
            <xsl:when test="messagetype = 'backlog'">
                <name code="1" codeSystem="{$oidEUMessageType}" displayName="backlog"/>
            </xsl:when>
            ...
            <xsl:when test="messagetype = 'masterichicsr'">
                <name code="2" codeSystem="{$oidEUMessageType}" displayName="masterichicsr"/>
            </xsl:when>
    ...
    <xsl:template match="safetyreport" mode="main">
        <subject typeCode="SUBJ">
            <investigationEvent classCode="INVSTG" moodCode="EVN">
                ...
                <code code="PAT_ADV_EVNT" codeSystem="2.16.840.1.113883.5.4" displayName="Narrativeincludeclinical"/>
...
<xsl:comment> J2.7.1: 完了䚸未完了༊分	Complete/Incomplete </xsl:comment>-->
                ...
                <xsl:apply-templates select="literature" mode="FDA-Literature"/>
                <!--J2・15・r-->
                ...
                <xsl:if test="string-length(additionaldocument) > 0">
                    ...
                    <component typeCode="COMP">
                        <observationEvent classCode="OBS" moodCode="EVN">
                            <code code="{$AdditionalDocumentsAvailable}" codeSystem="{$oidObservationCode}" displayName="Additionaldocument"/>
                ...
                <xsl:if test="string-length(localcriteriareporttype) > 0">
                    <component typeCode="COMP">
                        <observationEvent classCode="OBS" moodCode="EVN">
                            <code code="C54588" codeSystem="{$oidLocalCriteriaReportTypeCode}" displayName="localCriteriaReportType"/>
                            <xsl:variable name="isNullFlavourLocCriteraRptType">
                                <xsl:call-template name="isNullFlavour">
                                    <xsl:with-param name="value" select="localcriteriareporttype"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <xsl:choose>
                                <xsl:when test="$isNullFlavourLocCriteraRptType = 'yes'">
                                    <xsl:variable name="NullFlavourWOSqBrcktLocCriteraRptType">
                                        <xsl:call-template name="getNFValueWithoutSqBrckt">
                                            <xsl:with-param name="nfvalue" select="localcriteriareporttype"/>
                                        </xsl:call-template>
                                    </xsl:variable>
                                    <value xsi:type="CE" nullFlavor="{$NullFlavourWOSqBrcktLocCriteraRptType}"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <value xsi:type="CE" code="{localcriteriareporttype}" codeSystem="{$oidLocalCriteriaReportTypeValue}"/>
                                </xsl:otherwise>
                            </xsl:choose>
                            <xsl:comment>  FDA.C.1.7.1 Local Criteria Report Type     </xsl:comment>
                        </observationEvent>
                    </component>
                </xsl:if>

                <xsl:if test="string-length(combinationproductreport) > 0">
                    <component typeCode="COMP">
                        <observationEvent classCode="OBS" moodCode="EVN">
                            <code code="C156384" codeSystem="{$oidCombinationProductReport}" displayName="Combination Product Report Indicator"/>
                            <xsl:variable name="isNullFlavourCombProdRpt">
                                <xsl:call-template name="isNullFlavour">
                                    <xsl:with-param name="value" select="combinationproductreport"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <xsl:choose>
                                <xsl:when test="$isNullFlavourCombProdRpt = 'yes'">
                                    <xsl:variable name="NullFlavourWOSqBrcktCombProdRpt">
                                        <xsl:call-template name="getNFValueWithoutSqBrckt">
                                            <xsl:with-param name="nfvalue" select="combinationproductreport"/>
                                        </xsl:call-template>
                                    </xsl:variable>
                                    <value xsi:type="BL" nullFlavor="{$NullFlavourWOSqBrcktCombProdRpt}"/>
                                </xsl:when>
                                <xsl:otherwise>
                                    <value xsi:type="BL" value="{combinationproductreport}"/>
                                </xsl:otherwise>
                            </xsl:choose>
                            <xsl:comment>  FDA.C.1.12 Combination Product Report Indicator    </xsl:comment>
                        </observationEvent>
                    </component>
                </xsl:if>
...
<xsl:call-template name="fulfillexpeditecriteria"/>-->
                ...
                <xsl:if test="string-length(icsrsource)> 0">
                    ...
                    <outboundRelationship typeCode="SPRT">
                        <relatedInvestigation classCode="INVSTG" moodCode="EVN">
                            <code code="{$InitialReport}" codeSystem="{$oidReportRelationCode}" displayName="initialReport"/>
                            <subjectOf2 typeCode="SUBJ">
                                <controlActEvent classCode="CACT" moodCode="EVN">
                                    <author typeCode="AUT">
                                        <assignedEntity classCode="ASSIGNED">
                                            <code code="{icsrsource}" codeSystem="{$oidFirstSender}" displayName="Casesendertype"/>
                                        </assignedEntity>
                                    </author>
                                </controlActEvent>
                            </subjectOf2>
                ...
                <xsl:if test="string-length(reporttype) > 0">
                    ...
                    <subjectOf2 typeCode="SUBJ">
                        <investigationCharacteristic classCode="OBS" moodCode="EVN">
                            <code code="{$ReportType}" codeSystem="{$oidReportCharacterizationCode}" displayName="Reporttype"/>
                            <xsl:choose>
                                <xsl:when test="reporttype= 1">
                                    <value xsi:type="CE" code="{reporttype}" codeSystem="{$oidReportType}" displayName="SpontaneousReport"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 2">
                                    <value xsi:type="CE" code="{reporttype}" codeSystem="{$oidReportType}" displayName="ReportFromStudy"/>
                                </xsl:when>
                                <xsl:when test="reporttype=3">
                                    <value xsi:type="CE" code="{reporttype}" codeSystem="{$oidReportType}" displayName="Other"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 4">
                                    <value xsi:type="CE" code="{reporttype}" codeSystem="{$oidReportType}" displayName="Notavailabletosender/unknown"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 01">
                                    <value xsi:type="CE" code="1" codeSystem="{$oidReportType}" displayName="SpontaneousReport"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 02">
                                    <value xsi:type="CE" code="2" codeSystem="{$oidReportType}" displayName="ReportFromStudy"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 03">
                                    <value xsi:type="CE" code="3" codeSystem="{$oidReportType}" displayName="Other"/>
                                </xsl:when>
                                <xsl:when test="reporttype= 04">
                                    <value xsi:type="CE" code="4" codeSystem="{$oidReportType}" displayName="Notavailabletosender/unknown"/>
                                </xsl:when>
                                ...
                                <xsl:when test="reporttype= 'StimulatedSpontaneous'">
                                    <value xsi:type="CE" code="1" codeSystem="{$oidReportType}" displayName="StimulatedSpontaneous"/>
                                </xsl:when>
                ...
                <subjectOf2 typeCode="SUBJ">
                    <investigationCharacteristic classCode="OBS" moodCode="EVN">
                        <code code="{$OtherCaseIDs}" codeSystem="{$oidReportCharacterizationCode}" displayName="Duplicate"/>
                ...
                <xsl:if test="string-length(casenullificationoramendment) > 0">
                    ...
                    <subjectOf2 typeCode="SUBJ">
                        <investigationCharacteristic classCode="OBS" moodCode="EVN">
                            <code code="{$NullificationAmendmentCode}" codeSystem="{$oidReportCharacterizationCode}" displayName="Casenullification"/>
                            <value xsi:type="CE" code="{casenullificationoramendment}" codeSystem="{$oidNullificationAmendment}"/>
                        </investigationCharacteristic>
                    </subjectOf2>
                </xsl:if>
                ...
                <xsl:if test="string-length(nullificationoramendmentreason) > 0">
                    ...
                    <subjectOf2 typeCode="SUBJ">
                        <investigationCharacteristic classCode="OBS" moodCode="EVN">
                            <code code="{$NullificationAmendmentReason}" codeSystem="{$oidReportCharacterizationCode}" displayName="Nullificationreason"/>
                            <value xsi:type="CE">
...
-->
    <xsl:template match="additionaldocuments">
        ...
        <xsl:if test="string-length(.) > 0">
            <xsl:variable name="positionDhbs">
                <xsl:value-of select="position()"/>
            </xsl:variable>
            <xsl:if test="string-length(documentlist) > 0">
                <xsl:comment>C.1.6.1.r: Documents Held by Sender - (<xsl:value-of select="$positionDhbs" />)</xsl:comment>
                <reference typeCode="REFR">
                    <document classCode="DOC" moodCode="EVN">
                        <code codeSystem="{$oidichreferencesource}" code="{$documentsHeldBySender}" codeSystemVersion="{$fdaOidC161rCLVersion}"
                              displayName="Document"/>
                        <xsl:comment>C.1.6.1.r.1: List of documents held by sender</xsl:comment>
                        <title>
                            <xsl:value-of select="documentlist"/>
                        </title>
                        <xsl:if test="string-length(includedocuments) > 0">
...
-->
    ...
    <xsl:template match="reportduplicate">
        <xsl:if test="string-length(duplicatesource)>0 or string-length(duplicatenumb)>0">
            <xsl:variable name="positionRptDup">
                <xsl:value-of select="position()"/>
            </xsl:variable>

            <xsl:comment>C.1.9.1.r: Duplicate Report Information - (<xsl:value-of select="$positionRptDup"/>)</xsl:comment>
            <subjectOf1 typeCode="SUBJ">
                <controlActEvent classCode="CACT" moodCode="EVN">
                    <!--A.1.11.r.1 Source(s) of the Case Identifier-->
                    <!--A.1.11.r.2 Case Identifier(s)-->
                    <xsl:comment>C.1.9.1.r.1: Source(s) of the Case Identifier</xsl:comment>
                ...
                <subjectOf2 typeCode="SUBJ">
                    <controlActEvent classCode="CACT" moodCode="EVN">
                        <author typeCode="AUT">
                            <assignedEntity classCode="ASSIGNED">
                                <addr>
                                    <xsl:if test="string-length(reporterstreet) > 0">
                                    ...
                                    <telecom>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$isNullFlavourMaskTelecom = 'yes'">
                                                ...
                                                <xsl:attribute name="value">tel</xsl:attribute>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:attribute name="value">
                                                    <xsl:value-of select="concat('tel:', reportertel)"/>
                                                </xsl:attribute>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </telecom>
                                ...
                                <xsl:if test="string-length(reporteremail) > 0">
                                    <telecom>
                                        <xsl:variable name="isNullFlavourRepEmail">
                                            <xsl:call-template name="isNullFlavour">
                                                <xsl:with-param name="value" select="reporteremail"/>
                                            </xsl:call-template>
                                        </xsl:variable>
                                        <xsl:choose>
                                            <xsl:when test="$isNullFlavourRepEmail = 'yes'">
                                                <xsl:variable name="NullFlavourWOSqBrcktRepEmail">
                                                    <xsl:call-template name="getNFValueWithoutSqBrckt">
                                                        <xsl:with-param name="nfvalue" select="reporteremail"/>
                                                    </xsl:call-template>
                                                </xsl:variable>
                                                <xsl:attribute name="nullFlavor">
                                                    <xsl:value-of select="$NullFlavourWOSqBrcktRepEmail"/>
                                                </xsl:attribute>
                                                <xsl:attribute name="value">mailto</xsl:attribute>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:attribute name="value">
                                                    <xsl:value-of select="concat('mailto:', reporteremail)"/>
                                                </xsl:attribute>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </telecom>
                                    <xsl:comment>  FDA.C.2.r.2.8: Reporter's Email  </xsl:comment>
                                </xsl:if>
                                ...
                                <assignedPerson classCode="PSN" determinerCode="INSTANCE">
                                    ...
                                    <name>
                                        ...
                                        <xsl:if test="string-length(reporterfirstname) > 0">
                                            <xsl:call-template name="field-or-mask">
                                        ...
                                        <asQualifiedEntity classCode="QUAL">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$isNullFlavourMaskQual = 'yes'">
                                                    ...
                                                    <code nullFlavor="{$NullFlavourWOSqBrcktQual}" codeSystem="{$oidQualification}"/>
                                                </xsl:when>
                                                <xsl:otherwise>
    ...
    <!-- C.3 Informaton on Sender Of Case Safety Report:
	E2B(R2): element "sender" inside "ichicsr/ichicsrbatchheader/ichicsrmessageheader/safetyreport"
            ...
            <controlActEvent classCode="CACT" moodCode="EVN">
                <author typeCode="AUT">
                    <assignedEntity classCode="ASSIGNED">
                        ...
                        <xsl:if test="string-length(sendertype) > 0">
                            <xsl:choose>
                                <xsl:when test="sendertype= 1">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="PharmaceuticalCompany"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 2">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="RegulatoryAuthority"/>
                                </xsl:when>
                                <xsl:when test="sendertype=3">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="HealthProfessional"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 4">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="RegionalPharmacovigilanceCentre"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 5">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="WHOcollaboratingcentresforinternationaldrugmonitoring"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 6">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="Other(e.g.distributororotherorganisation)"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 7">
                                    <code code="{sendertype}" codeSystem="{$oidSenderType}" displayName="Patient/Consumer"/>
                                </xsl:when>

                                <xsl:when test="sendertype= 01">
                                    <code code="1" codeSystem="{$oidSenderType}" displayName="PharmaceuticalCompany"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 02">
                                    <code code="2" codeSystem="{$oidSenderType}" displayName="RegulatoryAuthority"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 03">
                                    <code code="3" codeSystem="{$oidSenderType}" displayName="HealthProfessional"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 04">
                                    <code code="4" codeSystem="{$oidSenderType}" displayName="RegionalPharmacovigilanceCentre"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 05">
                                    <code code="5" codeSystem="{$oidSenderType}" displayName="WHOcollaboratingcentresforinternationaldrugmonitoring"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 06">
                                    <code code="6" codeSystem="{$oidSenderType}" displayName="Other(e.g.distributororotherorganisation)"/>
                                </xsl:when>
                                <xsl:when test="sendertype= 07">
                                    <code code="7" codeSystem="{$oidSenderType}" displayName="Patient/Consumer"/>
                                </xsl:when>
                                ...
                                <xsl:when test="sendertype= 'REGIONAL PHARMACOVIGILANCE CENTRE'">
                                    <code code="{$oidSenderType}" codeSystem="{$oidSenderType}" displayName="RegionalPharmacovigilanceCentre"/>
                                </xsl:when>
                        ...
                        <addr>
                            <xsl:if test="string-length(senderstreet) > 0">
                                <xsl:call-template name="field-or-mask">
                                    <xsl:with-param name="element">streetAddressLine</xsl:with-param>
                            ...
                            <xsl:if test="string-length(sendercity) > 0">
                                <xsl:call-template name="field-or-mask">
                                    <xsl:with-param name="element">city</xsl:with-param>
                            ...
                            <xsl:if test="string-length(senderstate) > 0">
                                <xsl:call-template name="field-or-mask">
                                    <xsl:with-param name="element">state</xsl:with-param>
                            ...
                            <xsl:if test="string-length(senderpostcode) > 0">
                                <xsl:call-template name="field-or-mask">
                                    <xsl:with-param name="element">postalCode</xsl:with-param>
                        ...
                        <assignedPerson classCode="PSN" determinerCode="INSTANCE">
                            ...
                            <name>
                                <xsl:if test="string-length(sendertitle) > 0">
                                    <xsl:call-template name="field-or-mask">
                                        <xsl:with-param name="element">prefix</xsl:with-param>
                                ...
                                <xsl:if test="string-length(senderfirstname) > 0">
                                    <xsl:call-template name="field-or-mask">
                                        <xsl:with-param name="element">given</xsl:with-param>
                                ...
                                <xsl:if test="string-length(sendermiddlename) > 0">
                                    <xsl:call-template name="field-or-mask">
                                        <xsl:with-param name="element">given</xsl:with-param>
                                ...
                                <xsl:if test="string-length(senderlastname) > 0">
                                    <xsl:call-template name="field-or-mask">
                                        <xsl:with-param name="element">family</xsl:with-param>
...
E2B(R3): element "role"  -->
                ...
                <subjectOf2 typeCode="SBJ">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$LastMenstrualPeriodDate}" codeSystem="{$oidObservationCode}"
                              displayName="Parentlastmenstrualdate"/>
                        <xsl:choose>
                            ...
                            <component typeCode="COMP">
                                <observation moodCode="EVN" classCode="OBS">
                                    <code code="{$HistoryAndConcurrentConditionText}" codeSystem="{$oidObservationCode}"
                                          displayName="Parentmedicalrelevanttext"/>
                ...
                <subjectOf2 typeCode="SBJ">
                    <organizer classCode="CATEGORY" moodCode="EVN">
                        <code code="{$DrugHistory}" codeSystem="{$oidValueGroupingCode}"
                              displayName="Parentpastdrugtherapy"/>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:if test="string-length(parentmpidversion) > 0 and string-length(parentmpid) > 0">
                                            ...
                                            <code code="{parentmpid}" codeSystem="{$oidProdIdentifier}"
                                                  codeSystemVersion="{parentmpidversion}" displayName="Parpastdrugmedicinalprodid"/>
                                        </xsl:if>
                                        <xsl:if test="string-length(parentphpidversion) > 0 and string-length(parentphpid) > 0">
                                            ...
                                            <code code="{parentphpid}" codeSystem="PhPID"
                                                  codeSystemVersion="{parentphpidversion}" displayName="Parpastdrugpharmaprodid"/>
                                        </xsl:if>
                                        <name>
                    ...
                    <outboundRelationship2 typeCode="RSON">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$Indication}" codeSystem="{$oidObservationCode}"
                                  codeSystemVersion="{$ichoidObservationCLVersion}" displayName="Parent Past indication"/>
    ...
    <xsl:template match="patient" mode="characteristics">
        ...
        <xsl:if test="string-length(patientonsetage) > 0 and string-length(patientonsetageunit) > 0">
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$Age}" codeSystem="{$oidObservationCode}" displayName="Patientonsetage"/>
        ...
        <xsl:if test="string-length(patientagegroup)>0">
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$AgeGroup}" codeSystem="{$oidObservationCode}" displayName="Patientagegroup"/>
                    <xsl:choose>
                        <xsl:when test="(patientagegroup)= 0">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Foetus"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 1">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Neonate(PretermandTermnewborns)"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 2">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Infant"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)=3">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Child"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 4">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Adolescent"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 5">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Adult"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 6">
                            <value xsi:type="CE" code="{patientagegroup}" codeSystem="{$oidAgeGroup}" displayName="Elderly"/>
                        </xsl:when>

                        <xsl:when test="(patientagegroup)= 01">
                            <value xsi:type="CE" code="1" codeSystem="{$oidAgeGroup}" displayName="Neonate(PretermandTermnewborns)"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 02">
                            <value xsi:type="CE" code="2" codeSystem="{$oidAgeGroup}" displayName="Infant"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 03">
                            <value xsi:type="CE" code="3" codeSystem="{$oidAgeGroup}" displayName="Child"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 04">
                            <value xsi:type="CE" code="4" codeSystem="{$oidAgeGroup}" displayName="Adolescent"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 05">
                            <value xsi:type="CE" code="5" codeSystem="{$oidAgeGroup}" displayName="Adult"/>
                        </xsl:when>
                        <xsl:when test="(patientagegroup)= 06">
                            <value xsi:type="CE" code="6" codeSystem="{$oidAgeGroup}" displayName="Elderly"/>
                        </xsl:when>
                        ...
                        <xsl:when test="(patientagegroup)= 'Foetus'">
                            <value xsi:type="CE" code="0" codeSystem="{$oidAgeGroup}" displayName="Foetus"/>
                        </xsl:when>
        ...
        <xsl:if test="string-length(patientweight) > 0">
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$BodyWeight}" codeSystem="{$oidObservationCode}" displayName="Patientweight"/>
        ...
        <xsl:if test="string-length(patientheight) > 0">
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$Height}" codeSystem="{$oidObservationCode}" displayName="Patientheight"/>
        ...
        <xsl:if test="string-length(patientlastmenstrualdate) > 0">
            ...
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$LastMenstrualPeriodDate}" codeSystem="{$oidObservationCode}"
                          displayName="Patientlastmenstrualdate"/>
        ...
        <xsl:apply-templates select="fdapatientraceinfo" mode="FDA-patient-race"/>

        <!-- FDA.D.12: Patient Ethnicity Group -->
        <xsl:if test="string-length(patientethnicitygroup) > 0 ">
            <subjectOf2 typeCode="SBJ">
                <observation classCode="OBS" moodCode="EVN">
                    <code code="C16564" displayName="Patient Ethnic Group" codeSystem="{$oidPatientEthnicityGroup}"/>
                    <xsl:variable name="isNullFlavourPatEthnicGrp">
                        <xsl:call-template name="isNullFlavour">
                            <xsl:with-param name="value" select="patientethnicitygroup"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="$isNullFlavourPatEthnicGrp = 'yes'">
                            <xsl:variable name="NullFlavourWOSqBrcktPatEthnicGrp">
                                <xsl:call-template name="getNFValueWithoutSqBrckt">
                                    <xsl:with-param name="nfvalue" select="patientethnicitygroup"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <value xsi:type="CE" nullFlavor="{$NullFlavourWOSqBrcktPatEthnicGrp}" codeSystem="{$oidPatientEthnicityGroup}"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <value xsi:type="CE" code="{patientethnicitygroup}" codeSystem="{$oidPatientEthnicityGroup}"/>
                        </xsl:otherwise>
                    </xsl:choose>
                    <xsl:comment>  FDA.D.12 Patient Ethnicity Code  </xsl:comment>
                </observation>
            </subjectOf2>
        </xsl:if>
            ...
            <subjectOf2 typeCode="SBJ">
                <organizer classCode="CATEGORY" moodCode="EVN">
                    ...
                    <xsl:if test="string-length(concomitanttherapies) > 0">
                        ...
                        <component typeCode="COMP">
                            <observation classCode="OBS" moodCode="EVN">
                                <code code="{$ConcommitantTherapy}" codeSystem="{$oidConcomitantTherapies}" displayName="Concomtherapy"/>
            ...
            <subjectOf2 typeCode="SBJ">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$Autopsy}" codeSystem="{$oidObservationCode}"
                          displayName="Patientautopsyyesno"/>
    ...
    <xsl:template name="patient-record">
        ...
        <xsl:if test="string-length($value) > 0">
            ...
            <asIdentifiedEntity classCode="IDENT">
                ...
                <xsl:if test="$code = 1">
                    <code code="{$code}" codeSystem="{$codeSystem}" displayName="Patientgpmedicalrecordnumb"/>
                </xsl:if>
                <xsl:if test="$code = 2">
                    <code code="{$code}" codeSystem="{$codeSystem}" displayName="Patientspecialistrecordnumb"/>
                </xsl:if>
                <xsl:if test="$code = 3">
                    <code code="{$code}" codeSystem="{$codeSystem}" displayName="Patienthospitalrecordnumb"/>
                </xsl:if>
                <xsl:if test="$code = 4">
                    <code code="{$code}" codeSystem="{$codeSystem}" displayName="Patientinvestigationnumb"/>
                </xsl:if>
            </asIdentifiedEntity>
        </xsl:if>
    </xsl:template>
            ...
            <substanceAdministration moodCode="EVN" classCode="SBADM">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:if test="string-length(patientmpidversion) > 0 and string-length(patientmpid) > 0">
                                            ...
                                            <code code="{patientmpid}" codeSystem="{$oidProdIdentifier}"
                ...
                <xsl:if test="string-length(patientdrugindication) > 0">
                    ...
                    <outboundRelationship2 typeCode="RSON">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$Indication}" codeSystem="{$oidObservationCode}"
                                  codeSystemVersion="{$ichoidObservationCLVersion}" displayName="Patient Past Drug indication"/>
                ...
                <xsl:if test="string-length(patientdrugreaction) > 0">
                    ...
                    <outboundRelationship2 typeCode="CAUS">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$Reaction}" codeSystem="{$oidObservationCode}"
                                  codeSystemVersion="{$ichoidObservationCLVersion}" displayName="Patient Past Drug Reaction"/>
        ...
        <outboundRelationship2 typeCode="DRIV">
            <observation moodCode="EVN" classCode="OBS">
                <code code="{$CauseOfDeath}" codeSystem="{$oidObservationCode}"
                      displayName="Patientdetermineautopsy"/>
    ...
    <xsl:template match="fdapatientraceinfo" mode="FDA-patient-race">
        <xsl:if test="string-length(patientrace) > 0">
            <xsl:variable name="positionPatientRace">
                <xsl:value-of select="position()"/>
            </xsl:variable>
            <xsl:comment>FDA.D.11.r.1: Patient Race Code - (<xsl:value-of select="$positionPatientRace"/>)</xsl:comment>
            <subjectOf2 typeCode="SBJ">
                <observation classCode="OBS" moodCode="EVN">
                    <code code="C17049" displayName="Race" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                    <xsl:variable name="isNullFlavourPatRace">
                        <xsl:call-template name="isNullFlavour">
                            <xsl:with-param name="value" select="patientrace"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="$isNullFlavourPatRace = 'yes'">
                            <xsl:variable name="NullFlavourWOSqBrcktPatRace">
                                <xsl:call-template name="getNFValueWithoutSqBrckt">
                                    <xsl:with-param name="nfvalue" select="patientrace"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <value xsi:type="CE" nullFlavor="{$NullFlavourWOSqBrcktPatRace}" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="patientrace = 'C16352'">
                                    <value xsi:type="CE" code="{patientrace}" displayName="African American" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                </xsl:when>
                                <xsl:when test="patientrace = 'C41259'">
                                    <value xsi:type="CE" code="{patientrace}" displayName="American Indian or Alaska Native" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                </xsl:when>
                                <xsl:when test="patientrace = 'C41260'">
                                    <value xsi:type="CE" code="{patientrace}" displayName="Asian" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                </xsl:when>
                                <xsl:when test="patientrace = 'C41219'">
                                    <value xsi:type="CE" code="{patientrace}" displayName="Native Hawaiian or Other Pacific Islander" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                </xsl:when>
                                <xsl:when test="patientrace = 'C41261'">
                                    <value xsi:type="CE" code="{patientrace}" displayName="White" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                </xsl:when>
                            </xsl:choose>
                        </xsl:otherwise>
                    </xsl:choose>
                    <xsl:comment>  FDA.D.11.r.1 Patient Race Code  </xsl:comment>
                </observation>
            </subjectOf2>
        ...
        <subjectOf2 typeCode="SBJ">
            <observation moodCode="EVN" classCode="OBS">
                    ...
                    <location typeCode="LOC">
                        <locatedEntity classCode="LOCE">
                            <locatedPlace classCode="COUNTRY" determinerCode="INSTANCE">
                                <code code="{reactionoccurcountry}" codeSystem="{$OidISOCountry}" displayName="Reaction Occur Country"/>
                            </locatedPlace>
                        </locatedEntity>
                    </location>
                </xsl:if>
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$ReactionForTranslation}" codeSystem="{$oidObservationCode}"
                                  displayName="Primarysourcereaction"/>
                            <value xsi:type="ED">
                ...
                <xsl:if test="string-length(termhighlighted) > 0">
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$TermHighlightedByReporter}" codeSystem="{$oidObservationCode}" displayName="Term Highlighted"/>
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$LifeThreatening}" codeSystem="{$oidObservationCode}"
                              displayName="Seriousness Life Threatening"/>
                        <xsl:call-template name="seriousness-criteria">
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$CausedProlongedHospitalisation}" codeSystem="{$oidObservationCode}" displayName="Seriousness Hospitalization"/>
                        <xsl:call-template name="seriousness-criteria">
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$DisablingIncapaciting}" codeSystem="{$oidObservationCode}" displayName="Seriousness Disabling"/>
                        <xsl:call-template name="seriousness-criteria">
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$CongenitalAnomalyBirthDefect}" codeSystem="{$oidObservationCode}" displayName="Seriousness Congenital Anomali"/>
                        <xsl:call-template name="seriousness-criteria">
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation moodCode="EVN" classCode="OBS">
                        <code code="{$OtherMedicallyImportantCondition}" codeSystem="{$oidObservationCode}" displayName="Seriousness Other"/>
                        <xsl:call-template name="seriousness-criteria">
                ...
                <outboundRelationship2 typeCode="PERT">
                    <observation classCode="OBS" moodCode="EVN">
                        <code code="7" codeSystem="{$oidReqiredIntervention}" displayName="Seriousness Required Intervention"/>
                        <xsl:call-template name="seriousness-criteria">
                            <xsl:with-param name="value" select="seriousnessreqintervention"/>
                        </xsl:call-template>
                        <xsl:comment>   FDA.E.i.3.2h:  Required Intervention   </xsl:comment>
                    </observation>
                </outboundRelationship2>
                ...
                <xsl:if test="string-length(reactionoutcome)>0">
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$Outcome}" codeSystem="{$oidObservationCode}" displayName="Reaction Outcome"/>
                ...
                <xsl:if test="string-length(reactionmedconfirmed) > 0">
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$MedicalConfirmationByHP}" codeSystem="{$oidObservationCode}" displayName="Reaction Medically confirmed"/>
                ...
                <observation moodCode="EVN" classCode="OBS">
                    <xsl:choose>
                        <xsl:when test="string-length(testmeddracode) > 0 and string-length(testmeddraversion) > 0">
                            ...
                            <code code="{testmeddracode}" codeSystem="{$oidMedDRA}" codeSystemVersion="{testmeddraversion}" displayName="Test Meddracode">
                    ...
                    <xsl:choose>
                        <xsl:when test="string-length(testresultcode) > 0">
                            ...
                            <interpretationCode code="{testresultcode}" codeSystem="{$oidTestResultCode}" displayName="Testresult Code"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <interpretationCode codeSystem="{$oidTestResultCode}" displayName="Testresult Code"/>
                        </xsl:otherwise>
                    </xsl:choose>
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            ...
                            <code code="{$Comment}" codeSystem="{$oidObservationCode}" displayName="Comment"/>
                            <xsl:choose>
                    ...
                    <outboundRelationship2 typeCode="REFR">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$MoreInformationAvailable}" codeSystem="{$oidObservationCode}" displayName="More Information Available"/>
                            <xsl:choose>
            ...
            <substanceAdministration moodCode="EVN" classCode="SBADM">
                ...
                <consumable typeCode="CSM">
                    <instanceOfKind classCode="INST">
                        ...
                        <xsl:if test="count(deviceinfo) > 0"  >
                            <xsl:if test="string-length(deviceinfo/devicelotnumber) > 0"  >
                                <xsl:comment>FDA.G.k.12.r.9: Device Lot Number</xsl:comment>
                                <productInstanceInstance classCode="MMAT" determinerCode="INSTANCE">
                                    <part>
                                        <partProductInstance>
                                            <lotNumberText>
                                                <xsl:value-of select="deviceinfo/devicelotnumber"/>
                                            </lotNumberText>
                                        </partProductInstance>
                                    </part>
                        ...
                        <kindOfProduct classCode="MMAT" determinerCode="KIND">
                            ...
                            <asManufacturedProduct classCode="MANU">
                                                ...
                                                <author typeCode="AUT">
                                                    <territorialAuthority classCode="TERR">
                                                        <territory classCode="NAT" determinerCode="INSTANCE">
                                                            ...
                                                            <code codeSystem="{$oidISOCountry}" code="{drugauthorizationcountry}" displayName="Drug Authorization Country"/>
                                                        </territory>
                                ...
                                <xsl:if test="string-length(spprodcategory) > 0">
                                    <xsl:comment>FDA.G.k.13.r FDA Specialized Product Category</xsl:comment>
                                    <subjectOf typeCode="SBJ">
                                        <characteristic classCode="OBS" moodCode="EVN">
                                            <code code="{$Spprodcategory}" codeSystem="{$oidSpprodcategory}" displayName="Spprodcategory"/>
                                            <value xsi:type="CE" code="{spprodcategory}" codeSystem="{$oidSpprodcategory}"/>
                                        </characteristic>
                                    </subjectOf>
                                </xsl:if>
                            ...
                            <xsl:if test="count(deviceinfo) > 0">
                                <xsl:apply-templates select="deviceinfo" mode="FDA-drug-deviceinfo"/>
                            </xsl:if>
                        ...
                        <xsl:if test="string-length(obtaindrugcountry) > 0">
                            ...
                            <subjectOf typeCode="SBJ">
                                <productEvent classCode="ACT" moodCode="EVN">
                                    <code code="{$RetailSupply}" codeSystem="{$oidActionPerformedCode}" displayName="Obtain Drug Country"/>
                ...
                <xsl:if test="string-length(investigationalblindedproduct) > 0">
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation classCode="OBS" moodCode="EVN">
                            <code code="{$Blinded}" codeSystem="{$oidObservationCode}" displayName="Investigational Product Blinded"/>
                ...
                <xsl:if test="string-length(drugcumulativedosagenumb) > 0">
                    ...
                    <outboundRelationship2 typeCode="SUMM">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$CumulativeDoseToReaction}" codeSystem="{$oidObservationCode}" displayName="cumulativeDoseToReaction"/>
                ...
                <xsl:if test="string-length(reactiongestationperiod) > 0 and string-length(reactiongestationperiodunit) > 0">
                    ...
                    <outboundRelationship2 typeCode="PERT">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$GestationPeriod}" codeSystem="{$oidObservationCode}" displayName="Reactiongestationperiod"/>
                ...
                <xsl:if test="string-length(fdadrugadditionalcode) > 0">
                    <xsl:comment>FDA.G.k.10a:  FDA Additional Information on Drug (coded)</xsl:comment>
                    <xsl:variable name="isNullFlavourDAC">
                        <xsl:call-template name="isNullFlavour">
                            <xsl:with-param name="value" select="fdadrugadditionalcode"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="$isNullFlavourDAC = 'yes'">
                            <xsl:variable name="NullFlavourWOSqBrcktDAC">
                                <xsl:call-template name="getNFValueWithoutSqBrckt">
                                    <xsl:with-param name="nfvalue" select="fdadrugadditionalcode"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <outboundRelationship2 typeCode="REFR">
                                <observation classCode="OBS" moodCode="EVN">
                                    <code code="{$CodedDrugInformation}" codeSystem="{$oidObservationCode}" displayName="Fdadrugadditionalcode"/>
                                    <value xsi:type="CE" codeSystem="{$FDAAdditionalInformationOnDrug}" nullFlavor="{$NullFlavourWOSqBrcktDAC}"/>
                                </observation>
                            </outboundRelationship2>
                        </xsl:when>
                        <xsl:otherwise>
                            <outboundRelationship2 typeCode="REFR">
                                <observation classCode="OBS" moodCode="EVN">
                                    <code code="{$CodedDrugInformation}" codeSystem="{$oidObservationCode}" displayName="Fdadrugadditionalcode"/>
                                    <value xsi:type="CE" codeSystem="{$FDAAdditionalInformationOnDrug}" code="{fdadrugadditionalcode}"/>
                                </observation>
                            </outboundRelationship2>
                        </xsl:otherwise>
                    </xsl:choose>
                ...
                <xsl:if test="string-length(drugadditionaltext) > 0">
                    <outboundRelationship2 typeCode="REFR">
                        <observation classCode="OBS" moodCode="EVN">
                            <code code="{$AdditionalCodedDrugInformation}" codeSystem="{$oidObservationCode}" displayName="Drugadditionaltext"/>
                ...
                <xsl:if test="string-length(actiondrug) > 0">
                    ...
                    <inboundRelationship typeCode="CAUS">
                        <act classCode="ACT" moodCode="EVN">
                            <code code="{actiondrug}" codeSystem="{$oidActionTaken}" displayName="Actiondrug"/>
                        </act>
                    </inboundRelationship>
                </xsl:if>
    ...
    <xsl:template match="deviceinfo" mode="FDA-drug-deviceinfo">
        <xsl:variable name="positionDeviceInfo">
            <xsl:value-of select="position()"/>
        </xsl:variable>

        <xsl:comment>G.k.12: Device Information - (<xsl:value-of select="$positionDeviceInfo"/>)</xsl:comment>
        <part classCode="PART">
            <partProduct classCode="DEV" determinerCode="KIND">
                <xsl:if test="string-length(productcode) > 0 ">
                    <code code="{productcode}" codeSystem="2.16.840.1.113883.3.26.1.1" displayName="Productcode"/>
                    <xsl:comment>   FDA.G.k.12.r.6 Device Product Code   </xsl:comment>
                </xsl:if>

                <!--   FDA Device Component Hierarchy    -->
                <xsl:if test="string-length(brandname) > 0 ">
                    <xsl:variable name="isNullFlavourBrandname">
                        <xsl:call-template name="isNullFlavour">
                            <xsl:with-param name="value" select="brandname"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="$isNullFlavourBrandname = 'yes'">
                            <xsl:variable name="NullFlavourWOSqBrcktBrandname">
                                <xsl:call-template name="getNFValueWithoutSqBrckt">
                                    <xsl:with-param name="nfvalue" select="brandname"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <name nullFlavor="{$NullFlavourWOSqBrcktBrandname}"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <name><xsl:value-of select="brandname"/></name>
                        </xsl:otherwise>
                    </xsl:choose>
                    <xsl:comment>  FDA.G.k.12.r.4 Device Brand Name    </xsl:comment>
                </xsl:if>

                <xsl:if test="string-length(commondevicename) > 0 ">
                    <xsl:variable name="isNullFlavourCommondevicename">
                        <xsl:call-template name="isNullFlavour">
                            <xsl:with-param name="value" select="commondevicename"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="$isNullFlavourCommondevicename = 'yes'">
                            <xsl:variable name="NullFlavourWOSqBrcktCommondevicename">
                                <xsl:call-template name="getNFValueWithoutSqBrckt">
                                    <xsl:with-param name="nfvalue" select="commondevicename"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <name nullFlavor="{$NullFlavourWOSqBrcktCommondevicename}"/>
                        </xsl:when>
                        <xsl:otherwise>
                            <name><xsl:value-of select="commondevicename"/></name>
                        </xsl:otherwise>
                    </xsl:choose>
                    <xsl:comment>  FDA.G.k.12.r.5 Common Device Name    </xsl:comment>
                </xsl:if>

                <asManufacturedProduct classCode="MANU">
                    <xsl:if test="count(manufacturer) > 0">
                        <manufacturerOrganization classCode="ORG" determinerCode="INSTANCE">
                            <xsl:if test="string-length(manufacturer/manufacturername)>0">
                                <name><xsl:value-of select="manufacturer/manufacturername"/></name>
                                <xsl:comment>  FDA.G.k.12.r.7.1a Device Manufacturer Name  </xsl:comment>
                            </xsl:if>
                            <xsl:if test="string-length(manufacturer/manufactureraddress)>0 or string-length(manufacturer/manufacturercity)>0 or string-length(manufacturer/manufacturerstate)>0 or string-length(manufacturer/manufacturercountry)>0">
                                <addr>
                                    <xsl:if test="string-length(manufacturer/manufactureraddress)>0">
                                        <streetAddressLine><xsl:value-of select="manufacturer/manufactureraddress"/></streetAddressLine>
                                        <xsl:comment>  FDA.G.k.12.r.7.1b Device Manufacturer Address  </xsl:comment>
                                    </xsl:if>
                                    <xsl:if test="string-length(manufacturer/manufacturercity)>0">
                                        <city><xsl:value-of select="manufacturer/manufacturercity"/></city>
                                        <xsl:comment>  FDA.G.k.12.r.7.1c Device Manufacturer City  </xsl:comment>
                                    </xsl:if>
                                    <xsl:if test="string-length(manufacturer/manufacturerstate)>0">
                                        <state><xsl:value-of select="manufacturer/manufacturerstate"/></state>
                                        <xsl:comment>  FDA.G.k.12.r.7.1d Device Manufacturer State  </xsl:comment>
                                    </xsl:if>
                                    <xsl:if test="string-length(manufacturer/manufacturercountry)>0">
                                        <country><xsl:value-of select="manufacturer/manufacturercountry"/></country>
                                        <xsl:comment>  FDA.G.k.12.r.7.1e Device Manufacturer Country  </xsl:comment>
                                    </xsl:if>
                                </addr>
                            </xsl:if>
                    ...
                    <xsl:if test="string-length(malfunction)>0">
                        <subjectOf typeCode="SBJ">
                            <characteristic classCode="OBS" moodCode="EVN">
                                <code code="C54026" codeSystem="2.16.840.1.113883.3.26.1.1" displayName="Malfunction"/>
                                <value value="{malfunction}" xsi:type="BL"/>
                                <xsl:comment>    FDA.G.k.12.r.1 Malfunction   </xsl:comment>
                            </characteristic>
                        </subjectOf>
                    </xsl:if>

                    <xsl:if test="count(deviceproblem) > 0">
                        <xsl:for-each select="deviceproblem">
                            <xsl:if test="string-length(deviceproblemcode) > 0">
                                <subjectOf typeCode="SBJ">
                                    <characteristic classCode="OBS" moodCode="EVN">
                                        <code code="C54451" codeSystem="2.16.840.1.113883.3.26.1.1" displayName="Device Problem Code"/>
                                        <value xsi:type="CE" code="{deviceproblemcode}" codeSystem="2.16.840.1.113883.3.26.1.1"/>
                                        <xsl:comment>    FDA.G.k.12.r.3.r Device Problem Code   </xsl:comment>
                                    </characteristic>
                                </subjectOf>
                            </xsl:if>
                        </xsl:for-each>
                    ...
                    <xsl:if test="string-length(deviceusage) > 0 ">
                        <subjectOf typeCode="SBJ">
                            <characteristic classCode="OBS" moodCode="EVN">
                                <code code="C54595" codeSystem="2.16.840.1.113883.3.989.2.1.1.19" displayName="Device Usage"/>
                                <value xsi:type="CE" code="{deviceusage}" codeSystem="2.16.840.1.113883.3.989.5.1.2.1.1.4">
                                    <xsl:choose>
                                        <xsl:when test="deviceusage = 1">
                                            <xsl:attribute name="displayName">Initial Use of Device</xsl:attribute>
                                        </xsl:when>

                                        <xsl:when test="deviceusage = 2">
                                            <xsl:attribute name="displayName">Reuse</xsl:attribute>
                                        </xsl:when>

                                        <xsl:when test="deviceusage = 3">
                                            <xsl:attribute name="displayName">Unknown</xsl:attribute>
                                        </xsl:when>
                                    </xsl:choose>
                                </value>
                                <xsl:comment>    FDA.G.k.12.r.8 Device Usage   </xsl:comment>
                            </characteristic>
                        </subjectOf>
                    </xsl:if>
                    ...
                    <xsl:if test="count(remedialaction) > 0">
                        <xsl:for-each select="remedialaction">
                            <xsl:if test="string-length(remedialactioninitiated) > 0 ">
                                <subjectOf typeCode="SBJ">
                                    <characteristic classCode="OBS" moodCode="EVN">
                                        <code code="C54594" codeSystem="2.16.840.1.113883.3.26.1.1" displayName="Remedial Action Initiated"/>
                                        <value xsi:type="CE" code="{remedialactioninitiated}" codeSystem="2.16.840.1.113883.3.989.5.1.2.1.1.3">
                                            <xsl:choose>

                                                <xsl:when test="remedialactioninitiated = 1 ">
                                                    <xsl:attribute name="displayName">Recall</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 2 ">
                                                    <xsl:attribute name="displayName">Repair</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 3 ">
                                                    <xsl:attribute name="displayName">Replacement</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 4 ">
                                                    <xsl:attribute name="displayName">Relabeling</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 5 ">
                                                    <xsl:attribute name="displayName">Notification</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 6 ">
                                                    <xsl:attribute name="displayName">Inspection</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 7 ">
                                                    <xsl:attribute name="displayName">Patient Monitoring</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 8 ">
                                                    <xsl:attribute name="displayName">Modification or Adjustment</xsl:attribute>
                                                </xsl:when>

                                                <xsl:when test="remedialactioninitiated = 9 ">
                                                    <xsl:attribute name="displayName">Other</xsl:attribute>
                                                </xsl:when>

                                            </xsl:choose>
                                        </value>
                                        <xsl:comment>    FDA.G.k.12.r.11.r Remedial Action Initiated  </xsl:comment>
                                    </characteristic>
                                </subjectOf>
                            </xsl:if>
                        </xsl:for-each>
                    ...
                    <xsl:if test="count(typeoffollowup) > 0">
                        <xsl:for-each select="typeoffollowup">
                            <xsl:if test="string-length(followuptype) > 0">
                                <subjectOf typeCode="SBJ">
                                    <characteristic classCode="OBS" moodCode="EVN">
                                        <code code="C54592" codeSystem="2.16.840.1.113883.3.26.1.1" displayName="Type of Follow Up Report"/>
                                        <value xsi:type="CE" code="{followuptype}" codeSystem="2.16.840.1.113883.3.989.5.1.2.1.1.5"/>
                                        <xsl:comment>    FDA.G.k.12.r.2.r If follow-up, what type?   </xsl:comment>
                                    </characteristic>
                                </subjectOf>
                            </xsl:if>
                        </xsl:for-each>
                    ...
                    <xsl:if test="string-length(operatorofdevice) > 0 ">
                        <subjectOf typeCode="SBJ">
                            <characteristic classCode="OBS" moodCode="EVN">
                                <code codeSystem="2.16.840.1.113883.3.989.5.1.2.1.1.6" code="{operatorofdevice}" displayName="Operatorofdevice"/>
                                <xsl:comment>  FDA.G.k.12.r.10 Device Operator  </xsl:comment>
                            </characteristic>
                        </subjectOf>
                    </xsl:if>
                </asManufacturedProduct>

<!--                <xsl:if test="string-length(devicelotnumber) > 0 ">-->
<!--                    <instanceOfKind classCode="INST">-->
<!--                        <productInstanceInstance classCode="MMAT" determinerCode="INSTANCE">-->
<!--                            <lotNumberText><xsl:value-of select="devicelotnumber"/></lotNumberText>-->
<!--                            <xsl:comment>  FDA.G.K.12.r.9  Device Lot number  </xsl:comment>-->
<!--                        </productInstanceInstance>-->
<!--                    </instanceOfKind>-->
<!--                </xsl:if>-->
    ...
    <xsl:template match="drugindications" mode="ICH-drug-indication">
        <xsl:if test="string-length(drugindicationterm) > 0 or string-length(drugindication) > 0 or string-length(drugindicationmeddraversion) > 0">
            ...
            <inboundRelationship typeCode="RSON">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$Indication}" codeSystem="{$oidObservationCode}" displayName="drugindication"/>
                    <xsl:choose>
    ...
    <xsl:template match="drugrelatedness" mode="ICH-recur">
        <xsl:if test="string-length(drugrecurreadministration)>0">
            <outboundRelationship2 typeCode="PERT">
                <observation moodCode="EVN" classCode="OBS">
                    <code code="{$RecurranceOfReaction}" codeSystem="{$oidObservationCode}" displayName="Drugrecurreadministration"/>
            ...
            <substanceAdministration classCode="SBADM" moodCode="EVN">
                ...
                <xsl:if test="string-length(drugparadministration) > 0 or (string-length(drugparadministrationtermid) > 0 and string-length(drugparadministrationtermidversion) > 0)">
                    ...
                    <inboundRelationship typeCode="REFR">
                        <observation moodCode="EVN" classCode="OBS">
                            <code code="{$ParentRouteOfAdministration}" codeSystem="{$oidObservationCode}" displayName="Drugparrouteofadmintermid"/>
                            <xsl:choose>
                                <xsl:when test="$isNullFlavourParRouteOfAdmin = 'yes'">
                                    ...
                                    <value xsi:type="CE" codeSystem="{$oidICHRoute}">
                                        <originalText nullFlavor="{$NullFlavourWOSqBrcktGk4r111}"/>
                                    </value>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:choose>
            ...
            <component typeCode="COMP">
                <causalityAssessment classCode="OBS" moodCode="EVN">
                    ...
                    <xsl:if test="string-length(drugassessmentsource) > 0">
                        <author typeCode="AUT">
                            <assignedEntity classCode="ASSIGNED">
                                <code displayName="Drugassessmentsource">
    ...
    <xsl:template match="summary">
        ...
        <xsl:if test="string-length(reportercomment) > 0">
            ...
            <component1 typeCode="COMP">
                <observationEvent moodCode="EVN" classCode="OBS">
                    <code code="{$Comment}" codeSystem="{$oidObservationCode}" displayName="Reportercomment"/>
                    <value xsi:type="ED" mediaType="text/plain">
                        <xsl:value-of select="reportercomment"/>
                    </value>
                    <author typeCode="AUT">
                        <assignedEntity classCode="ASSIGNED">
                            <code code="{$SourceReporter}" codeSystem="{$oidAssignedEntityRoleCode}" displayName="sourceReporter"/>
                        </assignedEntity>
                    </author>
                </observationEvent>
            </component1>
        ...
        <xsl:if test="string-length(sendercomment) > 0">
            ...
            <component1 typeCode="COMP">
                <observationEvent moodCode="EVN" classCode="OBS">
                    <code code="{$Comment}" codeSystem="{$oidObservationCode}" displayName="Sendercomment"/>
                    <value xsi:type="ED" mediaType="text/plain">
                        <xsl:value-of select="sendercomment"/>
                    </value>
                    <author typeCode="AUT">
                        <assignedEntity classCode="ASSIGNED">
                            <code code="{$Sender}" codeSystem="{$oidAssignedEntityRoleCode}" displayName="Sender"/>
                        </assignedEntity>
                    </author>
                </observationEvent>
            </component1>
  ...
  -->
    <xsl:template match="senderdiagnosisinformation" mode="ICH-case-summary">
        <xsl:if test="string-length(senderdiagnosis) > 0">
            ...
            <component1 typeCode="COMP">
                <observationEvent moodCode="EVN" classCode="OBS">
                    <code code="{$Diagnosis}" codeSystem="{$oidObservationCode}" displayName="Senderdiagnosismeddracode"/>
    ...
    <xsl:template match="summary/casesummarynarrative" mode="case-summary">
        <xsl:if test="string-length(reportercommentothlang) > 0 or string-length(narrativeothlang) > 0 or string-length(sendercommentothlang) > 0">
            ...
            <component typeCode="COMP">
                <observationEvent moodCode="EVN" classCode="OBS">
                    <code code="{$SummaryAndComment}" codeSystem="{$oidObservationCode}" displayName="Casesummary"/>
    ...
    <!-- FDA.C.5.6.r: IND number of cross reported IND (Repeat as necessary) -->
    <xsl:template match="crossreportedindinfo" mode="FDA-cross-reported-ind">
        <xsl:if test="string-length(crossreportedind) > 0">
            <xsl:variable name="positionCrossReportedInd">
                <xsl:value-of select="position()"/>
            </xsl:variable>
            <xsl:comment>FDA.C.5.6.r: IND number of cross reported IND - (<xsl:value-of select="$positionCrossReportedInd" />)</xsl:comment>
            <xsl:variable name="isNullFlavourCrossIND">
                <xsl:call-template name="isNullFlavour">
                    <xsl:with-param name="value" select="crossreportedind"/>
                </xsl:call-template>
            </xsl:variable>

            <xsl:choose>
                <xsl:when test="$isNullFlavourCrossIND = 'yes'">
                    <xsl:variable name="NullFlavourWOSqBrcktFDAC56r">
                        <xsl:call-template name="getNFValueWithoutSqBrckt">
                            <xsl:with-param name="nfvalue" select="crossreportedind"/>
                        </xsl:call-template>
                    </xsl:variable>
                    <authorization typeCode="AUTH">
                        <studyRegistration classCode="ACT" moodCode="EVN">
                            <xsl:comment>FDA.C.5.6.r: IND number of cross reported IND </xsl:comment>
                            <id nullFlavor ="{$NullFlavourWOSqBrcktFDAC56r}" root="{$oidCrossReportedInd}" />
                        </studyRegistration>
                    </authorization>
                </xsl:when>
                <xsl:otherwise>
                    <authorization typeCode="AUTH">
                        <studyRegistration classCode="ACT" moodCode="EVN">
                            <xsl:comment>FDA.C.5.6.r: IND number of cross reported IND </xsl:comment>
                            <id extension="{crossreportedind}" root="{$oidCrossReportedInd}"/>
                        </studyRegistration>
                    </authorization>
                </xsl:otherwise>
            </xsl:choose>
    ...
    <xsl:template match="literature" mode="FDA-Literature">
        <xsl:if test="string-length(.) > 0">

                        ...
                        <instanceOfKind classCode="INST">
                            <kindOfProduct classCode="MMAT" determinerCode="KIND">
                                ...
                                <xsl:if test="count(parentdrugsubstanceinfo) > 0">
                                    <xsl:apply-templates select="parentdrugsubstanceinfo"
                                                         mode="EMA-parent-past-drug-substance-info"/>
                                </xsl:if>
                        ...
                        <instanceOfKind classCode="INST">
                            <kindOfProduct classCode="MMAT" determinerCode="KIND">
                                ...
                                <xsl:if test="count(patientdrugsubstanceinfo) > 0">
                                    <xsl:apply-templates select="patientdrugsubstanceinfo"
                                                         mode="EMA-patient-past-drug-substance-info"/>
                                </xsl:if>
                            </kindOfProduct>
                        </instanceOfKind>
                    </consumable>

<%@ page import="com.rxlogix.util.ViewHelper; com.rxlogix.enums.TimeZoneEnum" %>
<style>
.input-group-btn:last-child>.btn, .input-group-btn:last-child>.btn-group { border-radius : 0px;}
.timezone-select-div {width: 100%;}
</style>
<div class="col-md-12">
    <div class="fuelux">
        <div class="form-horizontal scheduler m-t-5 m-l-10" role="form" id="myScheduler">
            <div class="col-xs-4 col-sm-4 col-md-4 start-datetime">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 form-group" id="timeSelect">
                        ...
                        <div class="input-group combobox start-time pl-10">
                            ...
                            <div class="input-group-btn">
                                <button type="button" class="btn btn-default dropdown-toggle inputbtn-height" data-toggle="dropdown">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 timezone-container">
                <div class="row">
                    <label class="col-sm-4 control-label scheduler-label">
                        <g:message code="scheduler.timezone" />
                    </label>
                </div>
                <div class="btn-group selectlist timezone timezone-select-div">
                    <button type="button" data-toggle="dropdown" class="btn btn-default dropdown-toggle timezone-button"
                            type="button" id="timeZoneDropDown">
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 repeat-container">
                <div class="row">
                    <label class="col-sm-4 control-label scheduler-label">
                        <g:message code="scheduler.repeat" />
                    </label>
                </div>
                <div class="form-group repeat-interval">
                    <div data-resize="auto" class="btn-group selectlist pull-left repeat-options">
                        <button type="button" data-toggle="dropdown" class="btn btn-default dropdown-toggle" id="setFrequency">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li data-value="afterEveryEtl"><a href="#"><g:message code="scheduler.afterEveryEtl" /></a></li>
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="row form-group repeat-end hide mt-10" aria-hidden="true" style="padding-left: 5px;">

                        <label class="col-sm-3 control-label scheduler-label"><g:message code="app.label.end" /></label>

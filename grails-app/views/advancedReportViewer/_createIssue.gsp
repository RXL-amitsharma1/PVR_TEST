...
<div id="createRodIssue" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row form-group">
                    <div class="col-lg-3">
                        <label for="issueNumber"><g:message code="rod.capa.capaNumber.label"/></label><span class="required-indicator">*</span>
                    ...
                    <div class="col-lg-3">
                        <label for="issueTypePopup"><g:message code="rod.capa.issueType.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="categoryPopup"><g:message code="rod.capa.category.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="remarksPopup"><g:message code="rod.capa.remarks.label"/></label>
                ...
                <div class="row form-group">
                    <div class="col-lg-3">
                        <label for="approvedByPopup"><g:message code="rod.capa.approvedBy.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="initiatorPopup"><g:message code="rod.capa.initiator.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="teamLeadPopup"><g:message code="rod.capa.teamLead.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="teamMembersPopup"><g:message code="rod.capa.teamMembers.label"/></label>
                        <select id="teamMembersPopup" name="teamMembersPopup" class="form-control select2-box" multiple="true">
                            <optgroup class="capaUsers" label="${g.message(code: 'user.label')}">
                            </optgroup>
                        </select>
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-lg-3">
                        <label for="rootCausePopup"><g:message code="rod.capa.rootCause.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="verificationResultsPopup"><g:message code="rod.capa.verificationResults.label"/></label>
                    ...
                    <div class="col-lg-3">
                        <label for="commentsPopup"><g:message code="rod.capa.comments.label"/></label>
                                        ...
                                        <input type="text" class="form-control" id="attach_file_name" readonly>
                                            <label class="input-group-btn">
                                                <span class="btn btn-primary browse-button">
                                                    ...
                                                    <input type="file" id="attach_file_input" name="file" multiple  class="browse-button" style="display: none;">
                                                </span>
                                            </label>
                                    </span>
                                </div>
                ...
                <div style="padding: 5px;" >
                    <table id="issue-number" class="table-striped pv-list-table dataTable no-footer" width="100%">
                        <thead>
                        <tr>

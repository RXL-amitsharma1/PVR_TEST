...
<script>
    $(function () {
        $('select.select2-box').select2({
            dropdownParent: $("#reportSubmissionModal")
        });
        ...
        <div>
            <div class="row">
                <div class="col-xs-4 form-group">
                    ...
                    <g:if test = "${currentState=='SCHEDULED'}">
                        <g:select name="icsrCaseState"
                                  from="${ViewHelper.getCaseSubmissionStatusEnumFinalI18n()}" optionKey="name"
                                  optionValue="display" class="form-control select2-box icsrCaseState"/>
                    </g:if>
                    <g:else>
                        <g:select name="icsrCaseState"
                                  from="${ViewHelper.getCaseSubmissionStatusEnumI18n(noSubmisson)}" optionKey="name"
                                  optionValue="display" class="form-control select2-box icsrCaseState"/>
                    </g:else>
                </div>
                <div class="col-xs-4 form-group">
            ...
            <div class="row" style="margin-top: 9px;">
                ...
                <div class="col-xs-8">
                    <div class="row">
                        ...
                        <div class="col-xs-4 timeZoneDiv" style="margin-left: 11px;">

...
<head>
    ...
    <title><g:message code="app.taskTemplate.create.title"/></title>
...
<div class="content">
    ...
    <g:form method="post" action="save" class="form-horizontal">
        <g:if test="${taskTemplateInstance.type== TaskTemplateTypeEnum.AGGREGATE_REPORTS}">
            <g:render template="includes/formReportTask" model="['mode':'create', taskTemplateInstance:taskTemplateInstance]" />
        </g:if>
        <g:elseif test="${taskTemplateInstance.type== TaskTemplateTypeEnum.PUBLISHER_SECTION}">
            <g:render template="includes/formPublisherSectionTask" model="['mode':'create', taskTemplateInstance:taskTemplateInstance]" />
        </g:elseif>
        <g:else>
            <g:render template="includes/form" model="['mode':'create', taskTemplateInstance:taskTemplateInstance]" />
        </g:else>
<div class="row">
    <div class="col-md-12">
        <div class="buttonBar ">

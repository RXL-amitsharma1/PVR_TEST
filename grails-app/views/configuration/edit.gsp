<%@ page import="com.rxlogix.enums.ReasonOfDelayAppEnum; groovy.json.JsonOutput;com.rxlogix.config.ReportTemplate; com.rxlogix.util.ViewHelper; com.rxlogix.util.DateUtil; com.rxlogix.config.Tag; com.rxlogix.enums.DateRangeValueEnum;" %>
<head>
    <meta name="layout" content="main"/>
    <title><g:message code="${configurationInstance?.pvqType?"app.configuration.autorca.title":"app.EditReport.title"}"/></title>
    <g:javascript>
...
<div class="content">
    <div class="container ">
                ...
                <div class="page-title-box">
                    <div class="fixed-page-head">
                        <div class="page-head-lt">
                            <div class="col-md-12">
                                <h5>${message(code: configurationInstance?.pvqType?"app.configuration.pvqcfg.title.edit":"app.label.editReport")} </h5>
                            </div>
                        </div>
        ...
        <div class="hide-space mt-30 mainContentDiv">
                ...
                <div class="pull-right rxmain-container-top m-r-20">
                    ...
                    <g:else>
                        <g:if test="${configurationInstance?.isEnabled && configurationInstance?.nextRunDate}">
                            <button type="button" class="btn pv-btn-grey" data-evt-clk='{"method": "beforeConfigurationFormSubmitWarningIfAny", "params": ["${createLink(controller: "configuration", action: "disable")}"]}' id="disabledButton">${message(code:"default.button.unschedule.label")}</button>
                        </g:if>
                        <g:else>
                            <button type="button" class="btn btn-primary report-edit-button" data-evt-clk='{"method": "beforeConfigurationFormSubmitWarningIfAny", "params": ["${createLink(controller: "configuration", action: "run")}", true]}' id="editRunButton">${message(code: 'default.button.run.label')}</button>
                        </g:else>

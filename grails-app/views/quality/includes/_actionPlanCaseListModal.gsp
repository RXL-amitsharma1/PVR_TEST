        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger hide modalError">
                    ...
                    <g:message code="app.actionPlan.summaryText.blank"/>
                </div>
                ...
                <div class="pv-caselist">
                    <table id="caseListTable" class="table table-striped pv-list-table dataTable no-footer" width="100%">
                        ...
                        <tr>
                            ...
                            <th><g:message code="quality.capa.rootCause.label"/><br><g:message code="quality.capa.responsibleParty.label"/></th>
                            <th></th>

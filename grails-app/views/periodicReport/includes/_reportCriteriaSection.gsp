    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class=" row p-t-0">
                    <div class="col-md-6">
                            ...
                            <div class="checkbox checkbox-primary checkbox-inline" style="width: 185px">
                        ...
                        <g:textField name="productGroupSelection"
                                     value="${configurationInstance?.productGroupSelection}" hidden="hidden"/>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div style="position:relative; display: inline-block; width: 185px" >&nbsp;</div>
                        <div class="wrapper">
                ...
                <div style="margin-top: 10px;" class="globalqueryWrapperRow">
                    ...
                    <div class="row queryContainer p-t-0">
                        ...
                        <div class="globalQueryDiv col-xs-10">
            ...
            %{--Date Range Type--}%
                ...
                <g:hiddenField name="sourceProfile.id" value="${SourceProfile?.central?.id}"/>
            ...
            %{--Inclusion Options--}%
            <div class="col-md-3 ${params.fromTemplate ? "hidden" : ""}">

    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-evt-clk='{"method": "closeAllImportValueModal", "params": []}' aria-label="Close"><span
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default cancel"
                        data-evt-clk='{"method": "closeAllImportValueModal", "params": []}'><g:message code="default.button.cancel.label"/></button>
                <button type="button" class="btn btn-success confirm-import"
                        data-evt-clk='{"method": "closeAllImportValueModal", "params": []}'><g:message code="default.button.confirm.label"/></button>
            </div>
        </div>
    </div>
</div>
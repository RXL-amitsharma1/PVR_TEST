<%@ page import="com.rxlogix.enums.DateRangeValueEnum; com.rxlogix.config.ReportTemplate; com.rxlogix.util.ViewHelper;  groovy.json.JsonOutput; com.rxlogix.util.DateUtil; com.rxlogix.config.Tag;" %>
<head>
    <meta name="layout" content="main"/>
    <title><g:message code="app.label.auto.rod.edit.title"/></title>
    <g:javascript>
    ...
    <div class="container ">
                ...
                <div class="page-title-box">
                    <div class="fixed-page-head">
                        <div class="page-head-lt">
                            <div class="col-md-12">
                                <h5>${message(code: "app.label.edit.auto.rod")} </h5>
                            </div>
                        </div>
                        <div class="pull-right">
                            <a href="${createLink(action: "jobExecutionHistory")}" target="_blank"><i class="fa fa-history" aria-hidden="true"></i>&nbsp;${message(code: "app.label.history")}&nbsp;&nbsp;</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hide-space mt-30">
            ...
            <form id="configurationForm" name="configurationForm" method="post" autocomplete="off" data-evt-sbt='{"method": "onFormSubmit", "params": []}'>
                ...
                <g:hiddenField name="id" value="${autoReasonOfDelayInstance?.id}"/>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-right rxmain-container-top m-r-20">
                            <button type="button" class="btn btn-primary" data-evt-clk='{"method": "beforeConfigurationFormSubmitWarningIfAny", "params": ["${createLink(controller: "autoReasonOfDelay", action: "update")}"]}' id="editUpdateButton">${message(code: 'default.button.update.label')}</button>

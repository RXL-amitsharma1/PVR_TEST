        ...
        <tr>
            ...
            <td class="container" bgcolor="#FFFFFF">
                ...
                <div class="content">
                        ...
                        <div style="width:50%">
                            ...
                            <span style="width:100%">
                                <g:if test="${mode == 'create'}">
                                    <span><g:message code="app.notification.comment.created"/></span>
                                    <span style="font-weight: bold;">${reportRequestName}</span>
                                </g:if>
                                <g:elseif test="${mode == 'update'}">
                                    <span><g:message code="app.notification.comment.updated"/></span>
                                    <span style="font-weight: bold;">${reportRequestName}</span>
                                </g:elseif>
                                <g:elseif test="${mode == 'delete'}">
                                    <span><g:message code="app.notification.comment.deleted"/></span>
                                    <span style="font-weight: bold;">${reportRequestName}</span>
                                </g:elseif>
                    ...
                    <div class="row" style="width:100%">
                        <div style="width:50%">
                            ...
                            <span>
                                ...
                                <g:elseif test="${mode == 'update'}">
                                    <g:if test="${comment == oldComment}">
                                        ${comment}
                                    </g:if>
                                    <g:else>
                                        <s>${oldComment}</s> ${comment}
                                    </g:else>
                                </g:elseif>
                                <g:elseif test="${mode == 'delete'}">
                                    <s>${comment}</s>
                    ...
                    <!-- Link -->
                    <div>
                        <a href="${url}"><g:message code="app.label.comment.link"/></a>
                    </div>

...
<head>
    ...
    <title><g:message code="app.label.interactiveHelp.pageTitle"/></title>
    <g:javascript>
       var listUrl="${createLink(controller: 'localizationHelpMessage', action: 'listInteractiveHelp')}";
    </g:javascript>
    <style>
...
<div class="content">
    <div class="container">
        <div>
            <rx:container title="${message(code: "app.label.interactiveHelp.list")}">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a href="${createLink(action: "interactiveHelp")}"><g:message code="app.label.interactiveHelp.interactiveHelp"/></a>
                    </li>
                ...
                <div class="body">
                    <div id="action-list-conainter" class="list pv-caselist">
                        ...
                        <div class="row">
                            <div class="col-md-1">
                                <div class="navScaffold">
                                    <g:link class="btn btn-primary" action="createInteractiveHelp">
                            ...
                            <div class="col-md-1">
                                <div class="navScaffold">
                                    <g:link class="btn btn-primary" action="exportInteractiveHelp">
                            ...
                            <div class="col-xs-4">
                                <form action="importInteractiveHelp" id="fileForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="pv-caselist">
                            <table id="interactiveHelpList" class="table table-striped pv-list-table dataTable no-footer">
                                <thead>
                                <tr>
                                    <th><g:message default="Title" code="app.label.localizationHelp.title"/></th>
                                    <th><g:message default="Pages" code="app.label.interactiveHelp.pages"/></th>

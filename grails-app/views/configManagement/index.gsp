...
<head>
    ...
    <asset:javascript src="app/configManagement.js"/>
    <title><g:message code="app.label.config.management"/></title>
</head>
<body>
<div id="accordion-pvr">
...
<div id="panelDiv" class="panel-collapse rxmain-container-content rxmain-container-show collapse in" aria-expanded="true" style="padding-top: 10px;">
    <!-------------------------------------------------------IMPORT--------------------------------------------------------->
    <div class="panel panel-default">
        ...
        <div id="collapse13" class="panel-collapse collapse open p-10">
            <div class="margin20Top">
                <form id="importConfigForm" enctype="multipart/form-data" method="post">
                    <div class="container"
                        ...
                        <div class="row" style="margin-top: 5px">
                            ...
                            <div class="col-sm-4" style="margin-top: 5px">
                                <input type="radio" id="busConfig" name="configType" disabled
                                       value="Business Configurations"> Business Configurations
                            </div>
                ...
                <div id="importStatusDiv"><img id="importStatusLoading"
                                               src="/reports/assets/loading.gif" width="30px"
                                               height="30px" class="hidden">
                </div>
            </div></div>
    </div>
    <!--------------------------------//-----------------------EXPORT--------------------------------------------------------->
        ...
        <div id="collapse15" class="panel-collapse collapse open p-10">
            <div class="margin20Top">
                <div class="margin20Top"><div class="container"
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6"><label>Modules</label>
                            <select name="configsSelect" id="configsSelect" disabled
                                ...
                                <option value="Technical Configurations" selected>Technical Configurations</option>
                            </select>
                        </div>
                    </div>
                    <BR>
                    ...
                    <div id="exportStatusDiv"><img id="exportStatusLoading"
                                                   src="/reports/assets/loading.gif" width="30px"
                                                   height="30px" class="hidden">
                        <div>
                            <a id="downloadExportFile" href="" class="hidden">Configuration Export File</a>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <div
        ...
        <div id="collapse14" class="panel-collapse collapse open p-10"><div class="margin20Top"><div
            ...
            <div id="compareStatusDiv"><img id="compareStatusLoading"
                                            src="/reports/assets/loading.gif" width="30px"
                                            height="30px" class="hidden">
                <div>
                    <a id="downloadDiffFile" href="" class="hidden">Configuration Difference File</a>
                </div>
            </div>

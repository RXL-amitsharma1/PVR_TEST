<div class="modal fade" id="bulkDownloadConfirmationModal"  data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="bulkDownloadConfirmationModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-dialog vertical-align-center">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary okButton" data-dismiss="modal">

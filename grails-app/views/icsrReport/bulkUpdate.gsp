...
<rx:container title="${message(code: "app.menu.bulkImportConfiguration")}" options="false" filterButton="false">
    ...
    <b><g:message code="app.menu.createFromTemplate"/></b>
    <div class="row">
        <div class="col-sm-3">   <select id="templates" class="form-control"></select></div>
        <div class="col-sm-1">  <button class="btn btn-primary create"><g:message code="default.button.create.label"/></button></div>
        <div class="col-sm-1">
            <form id="excelExportForm" action="${createLink(controller: 'periodicReport', action: 'exportToExcel')}" >
                <input name="filter" type="hidden">
                <button class="btn btn-primary export"><g:message code="app.label.exportTo"/> <g:message code="app.reportFormat.XLSX"/></button>
            </form>
        </div>
        <div class="col-sm-7">
            <form id="excelImportForm" name="excelImportForm" action="${createLink(controller: 'periodicReport', action: 'importExcel')}" enctype="multipart/form-data" method="post" >
            <div class="input-group add-margin" style="width: 50%; float: left">
                <input type="text" class="form-control" id="file_name" readonly>
                <label class="input-group-btn">
                    <span class="btn btn-primary">
                        <g:message code="controlPanel.medDra.excel.label"/>
...
<div id="primaryReportingDestinationEditDiv" class="popupBox" style="position: absolute; display: none">
    <input id="reportingDestination" class="form-control">
    <div style="margin-top: 10px; width: 100%; text-align: right;">
        <button class="btn btn-primary saveButton"><g:message code="default.button.save.label"/></button>
        <button class="btn pv-btn-grey cancelButton"><g:message code="default.button.cancel.label"/></button>
    </div>

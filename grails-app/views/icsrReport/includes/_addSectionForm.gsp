<%@ page import="com.rxlogix.util.ViewHelper; com.rxlogix.enums.DateRangeEnum" %>
<!-- Modal header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <g:textField name="title"
                                         maxlength="${gorm.maxLength(clazz: 'com.rxlogix.config.Configuration', field: 'reportName')}"

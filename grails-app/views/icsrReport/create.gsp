...
<head>
    ...
    <title><g:message code="app.CreateReport.label"/></title>
    <g:javascript>
        ...
        <div class="page-title-box">
            <div class="fixed-page-head">
                <div class="page-head-lt">
                    <div class="col-md-12">
                        <h5>${message(code: "app.icsrReport.title")} </h5>
                    </div>
                </div>
...
<form id="configurationForm" class="field-enter-submit-off" name="configurationForm" method="post" autocomplete="off" data-evt-sbt='{"method": "onFormSubmit", "params": []}'>
    ...
    <div class="mt-10 m-r-20 m-b-10">
        <div style="text-align: right">
            <button type="button" class="btn btn-primary" data-evt-clk='{"method": "beforePeriodicFormSubmitWarningIfAny", "params": ["${createLink(action: "run")}", true]}' id="saveAndRunButton">${message(code: 'default.button.saveAndRun.label')}</button>
            <button type="button" class="btn pv-btn-grey" data-evt-clk='{"method": "beforePeriodicFormSubmitWarningIfAny", "params": ["${createLink(action: "save")}"]}' id="saveButton">${message(code: 'default.button.save.label')}</button>
...
<div>
    ...
    <g:render template='/templateQuery/templateQuery'
              model="['templateQueryInstance': null, 'i': '_clone', 'hidden': true, isForPeriodicReport: false,isForIcsrReport: true ]"/>

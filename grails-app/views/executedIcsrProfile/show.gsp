<%@ page import="com.rxlogix.config.ExecutedCustomSQLQuery; com.rxlogix.Constants; grails.util.Holders; com.rxlogix.enums.DistributionChannelEnum; com.rxlogix.enums.DictionaryTypeEnum; com.rxlogix.util.ViewHelper" contentType="text/html;charset=UTF-8" %>
<html>
<head>
...
<rx:container title="${message(code: "app.label.icsr.profile.conf.exIcsrProfile")}">
...
%{--         <div class="row"> --}%
            <div class="col-md-2">
                ...
                <p>
                    ${icsrProfileConfInstance?.recipientOrganizationName} <a
                        href="${createLink(controller: 'unitConfiguration', action: 'showOrganizationDetails')}?orgName=${URLEncoder.encode(icsrProfileConfInstance?.recipientOrganizationName)}"><i
                            class="fa fa-info-circle" style="color:#077bac;"></i></a>
                </p>
            </div>
            ...
            <div class="col-md-2">
                ...
                <p>
                    ${ViewHelper.getOrganizationTypeByPreference(icsrProfileConfInstance?.recipientTypeName)}
                </p>
            </div>
            ...
            <div class="col-md-2">
                ...
                <p>${ViewHelper.getOrganizationCountryNameByPreference(icsrProfileConfInstance?.recipientCountry)}</p>
            </div>
            ...
            <div class="col-md-2">
                ...
                <p>
                    ${icsrProfileConfInstance?.senderOrganizationName} <a
                        href="${createLink(controller: 'unitConfiguration', action: 'showOrganizationDetails')}?orgName=${URLEncoder.encode(icsrProfileConfInstance?.senderOrganizationName)}"><i
                            class="fa fa-info-circle" style="color:#077bac;"></i></a>
                </p>
            </div>
            ...
            <div class="col-md-2">
                ...
                <p>
                    ${ViewHelper.getOrganizationTypeByPreference(icsrProfileConfInstance?.senderTypeName)}
            ...
            <div class="col-md-2">
                <div class="checkbox checkbox-primary">
                    <g:checkBox id="isDisabled" disabled=""
                                ...
                                checked="${icsrProfileConfInstance?.isDisabled}"/>
        ...
        <g:if test="${icsrProfileConfInstance?.adjustDueDate}">
            <div class="col-md-2">
                ...
                <g:if test="${icsrProfileConfInstance?.calendars}">
                    <div>
                        <g:renderCalendarName
                                calendarIds="${icsrProfileConfInstance?.calendars}"></g:renderCalendarName>
                    </div>
                </g:if>
                <g:else>
                    <div><g:message code="app.label.none"/></div>
        ...
        <div class="row">
            <g:if test="${icsrProfileConfInstance.productSelection || icsrProfileConfInstance.validProductGroupSelection}">
                ...
                <div class="col-md-2">
                    ...
                    <div>
                        <g:formatBoolean boolean="${icsrProfileConfInstance?.includeWHODrugs}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <g:if test="${icsrProfileConfInstance.authorizationTypes}">
                            <div>
                                <g:renderIcsrAuthTypeName
                                        icsrAuthType="${icsrProfileConfInstance?.authorizationTypes}"></g:renderIcsrAuthTypeName>
                            </div>
                        </g:if>
                        <g:else>
                            <div><g:message code="app.label.none"/></div>
    ...
    <div class="rxmain-container rxmain-container-top">
        ...
        <div class="rxmain-container-content rxmain-container-show">
            <g:set var="e2bSelectedValue" value=""/>
            <g:each var="templateQuery" in="${templateQueries}" status="i">
                <g:if test="${(templateQuery?.distributionChannelName != DistributionChannelEnum.PAPER_MAIL)}">
                    <g:set var="e2bSelectedValue" value="${templateQuery?.distributionChannelName}"/>
                </g:if>
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <label><g:message code="app.label.icsr.profile.conf.expedited"/></label>
                    ...
                    <div class="col-md-1">
                        ...
                        <g:if test="${templateQuery?.icsrMsgType}">
                            <div>
                                <g:renderIcsrMsgTypeName
                                        icsrMsgType="${templateQuery?.icsrMsgType}"></g:renderIcsrMsgTypeName>
                            </div>
                        </g:if>
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        %{--<p><g:if test="${templateQuery?.distributionChannelName}"><g:message code="${templateQuery.distributionChannelName.getI18nKey()}"/></g:if></p>--}%
                        <p><g:if test="${templateQuery?.distributionChannelName}"><g:message
                                code="${templateQuery.distributionChannelName.getI18nKey()}"/></g:if>
                            <span class="showEmailConfiguration" data-evt-clk='{"method": "viewEmailConfiguration", "params": ["${this.id}"]}'
                                  id="showEmailConfiguration-${i}" <g:if
                                          test="${templateQuery?.distributionChannelName.toString() != 'EMAIL'}">style="cursor: pointer; display:none;"</g:if>
                                  <g:else>style="cursor: pointer;"</g:else>><asset:image
        ...
        <div class="rxmain-container-content rxmain-container-show">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <g:if test="${icsrProfileConfInstance?.executedDeliveryOption?.sharedWith || icsrProfileConfInstance?.executedDeliveryOption?.sharedWithGroup}">
                        <g:if test="${icsrProfileConfInstance?.executedDeliveryOption.sharedWith}">
                            <g:each in="${icsrProfileConfInstance?.executedDeliveryOption.sharedWith}">
                                <div>${it.reportRequestorValue}</div>
                            </g:each>
                        </g:if>
                        <g:if test="${icsrProfileConfInstance?.executedDeliveryOption.sharedWithGroup}">
                            <g:each in="${icsrProfileConfInstance?.executedDeliveryOption.sharedWithGroup}">
                                <div>${it.name}</div>
                            </g:each>
                        </g:if>
                    </g:if>
                ...
                <div class="col-md-2">
                    <g:render template="includes/showEmailDetail"
                              model="[instance: icsrProfileConfInstance, deliveryOption: icsrProfileConfInstance?.executedDeliveryOption]"/>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <div>
                        <g:formatBoolean boolean="${icsrProfileConfInstance?.qualityChecked}"
                                         true="${message(code: "default.button.yes.label")}"
                                         false="${message(code: "default.button.no.label")}"/>
                    </div>
                </div>
    ...
    <g:if test="${(e2bSelectedValue != DistributionChannelEnum.PAPER_MAIL)}">
        ...
        <div class="rxmain-container rxmain-container-top">
            ...
            <div class="rxmain-container-content rxmain-container-show">
                <div class="row">
                    ...
                    <g:if test="${(e2bSelectedValue == DistributionChannelEnum.PV_GATEWAY) || (e2bSelectedValue == DistributionChannelEnum.EXTERNAL_FOLDER)}">
                        <div class="col-md-2">
